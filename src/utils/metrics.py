...
class Metrics(object):
    def __init__(self, options, clients, name=''):
        ...
        if self.options['batch_size'] == 0:
            suffix = '{}_sd{}_lr{}_ne{}_I{}'.format(name,
                                            options['seed'],
                                            options['lr'],
                                            options['round_num'],
                                            options['I'],
            ...
            suffix = '{}_sd{}_lr{}_ne{}_bs{}_I{}'.format(name,
                                            options['seed'],
                                            options['lr'],
                                            options['round_num'],
                                            options['batch_size'],
        ...
        if self.options['sample'] == True:
            self.exp_name = '{}_{}_{}_{}_{}'.format(options['server'], 'sample', 
    ...
    def update_costs(self, round_i, costs, ):
        if round_i == 0:
            self.accumulation_delay[round_i] = costs[0] 
            self.accumulation_energy[round_i] += costs[1]
        else:
            self.accumulation_delay[round_i] = costs[0] + self.accumulation_delay[round_i - 1]
